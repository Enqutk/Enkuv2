...
fill(0.85, 0.85, 0.85)
txt(MARGIN, 734, 9, "Full Stack Developer  |  Intern & Intern Project Manager, Teter Trending PLC")
fill(0.45, 0.45, 0.45)
...
heading("Experience")
line("Intern & Intern Project Manager  |  Teter Trending PLC", 10.5, "F2", 13)
fill(0.4, 0.4, 0.4)
line("2026 - Present", 8.5, "F1", 13)
fill(0.08, 0.08, 0.08)
bullet("Intern project manager for the Akilil Digital Realm website, with direct client contact.")
bullet("Owned requirements, updates, and delivery from kickoff through launch.")
bullet("Built and shipped intern project work with the team.")
y -= 4
...
heading("Projects")
bullet("Akilil Digital Realm website - intern project manager and direct client contact.")
